...
GL_PROC(base_opengl, glOrtho, WINGDIAPI, void, (GLdouble left, GLdouble right, GLdouble bottom,
        GLdouble top, GLdouble zNear, GLdouble zFar))
GL_PROC(base_opengl, glScissor, WINGDIAPI, void, (GLint x, GLint y, GLsizei width, GLsizei height))
GL_PROC(base_opengl, glClearColor, WINGDIAPI, void, (GLclampf red, GLclampf green, GLclampf blue,
        GLclampf alpha))
...
GL_PROC(base_opengl, glTexImage2D, WINGDIAPI, void, (GLenum target, GLint level,
        GLint internalformat,
        GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels))
GL_PROC(base_opengl, glTexSubImage2D, WINGDIAPI, void, (GLenum target, GLint level, GLint xoffset,
...
GL_PROC(base_opengl, glVertexPointer, WINGDIAPI, void, (GLint size, GLenum type, GLsizei stride,
        const GLvoid *pointer))
GL_PROC(base_opengl, glColorPointer, WINGDIAPI, void, (GLint size, GLenum type, GLsizei stride,
        const GLvoid *pointer))
GL_PROC(base_opengl, glTexCoordPointer, WINGDIAPI, void, (GLint size, GLenum type, GLsizei stride,
        const GLvoid *pointer))
GL_PROC(base_opengl, glDrawArrays, WINGDIAPI, void, (GLenum mode, GLint first, GLsizei count))
GL_PROC(base_opengl, glDrawElements, WINGDIAPI, void, (GLenum mode, GLsizei count, GLenum type,
        const GLvoid *indices))
GL_PROC(base_opengl, glEnableClientState, WINGDIAPI, void, (GLenum array))
GL_PROC(base_opengl, glFinish, WINGDIAPI, void, (void))
GL_PROC(base_opengl, glReadPixels, WINGDIAPI, void, (GLint x, GLint y, GLsizei width,
        GLsizei height,
...
GL_PROC(GL_EXT_framebuffer_object, glRenderbufferStorageEXT, , void, (GLenum, GLenum, GLsizei,
        GLsizei))
...
GL_PROC(GL_EXT_framebuffer_object, glFramebufferRenderbufferEXT, , void, (GLenum, GLenum, GLenum,
        GLuint))
GL_PROC(GL_EXT_framebuffer_object, glFramebufferTexture2DEXT, , void, (GLenum, GLenum, GLenum,
        GLuint,
        GLint))
...
GL_PROC(GL_ARB_vertex_buffer_object, glBufferDataARB, , void, (GLenum, GLsizeiptr, const GLvoid *,
        GLenum))
