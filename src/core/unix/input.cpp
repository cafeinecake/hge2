...
static int SDLKeyToHGEKey(const int sdlkey)
{
  ...
  case SDLK_BACKSLASH:
    return HGEK_BACKSLASH;

  case SDLK_LEFTBRACKET:
    return HGEK_LBRACKET;

  case SDLK_RIGHTBRACKET:
    return HGEK_RBRACKET;

  case SDLK_SEMICOLON:
    return HGEK_SEMICOLON;

  case SDLK_QUOTE:
    return HGEK_APOSTROPHE;
