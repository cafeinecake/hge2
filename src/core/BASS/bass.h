...
HSTREAM BASSDEF(BASS_StreamCreate)(uint32_t freq, uint32_t chans, uint32_t flags, STREAMPROC *proc,
                                   uint32_t user);
HSTREAM BASSDEF(BASS_StreamCreateFile)(BOOL mem, const void *file, uint32_t offset, uint32_t length,
                                       uint32_t flags);
HSTREAM BASSDEF(BASS_StreamCreateURL)(const char *url, uint32_t offset, uint32_t flags,
                                      DOWNLOADPROC *proc, uint32_t user);
HSTREAM BASSDEF(BASS_StreamCreateFileUser)(BOOL buffered, uint32_t flags, STREAMFILEPROC *proc,
    uint32_t user);
...
HRECORD BASSDEF(BASS_RecordStart)(uint32_t freq, uint32_t chans, uint32_t flags, RECORDPROC *proc,
                                  uint32_t user);
...
BOOL BASSDEF(BASS_ChannelSet3DPosition)(uint32_t handle, const BASS_3DVECTOR *pos,
                                        const BASS_3DVECTOR *orient, const BASS_3DVECTOR *vel);
BOOL BASSDEF(BASS_ChannelGet3DPosition)(uint32_t handle, BASS_3DVECTOR *pos, BASS_3DVECTOR *orient,
                                        BASS_3DVECTOR *vel);
...
HSYNC BASSDEF(BASS_ChannelSetSync)(uint32_t handle, uint32_t type, QWORD param, SYNCPROC *proc,
                                   uint32_t user);
