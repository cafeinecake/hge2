...
public:
  ...
  virtual void    CALL  Channel_SlideTo(HCHANNEL channel, float time, int volume, int pan = -101,
                                        float pitch = -1) = 0;
  ...
  virtual HTEXTURE  CALL  Texture_Load(const char *filename, uint32_t size = 0,
